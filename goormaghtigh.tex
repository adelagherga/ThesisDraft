...
(\edit{maybe change the title here so taht we can incorporate everything into one subsection})
...
\edit{The remainder of this paper loosely follows the arguments of \cite{TW3}, with certain modifications designed to improve our timing efficiency. }


\edit{could probably delete from here to}
...
\edit{ could probably delete up to here}
%---------------------------------------------------------------------------------------------------------------------------------------------%
