...
solutions in the positive integers $x,y,z$. Qualitative questions of this type
...
f(x,y) = a,
\end{equation}
where $f(x,y)$ is an integral binary form of degree $n \geq 3$ and $a$ is a fixed nonzero rational integer. In 1909, Thue
